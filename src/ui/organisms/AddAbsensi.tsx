...
const AddAbsensi: React.FC<AddAbsensiProps> = ({ disabled = false, attachments, setAttachments }) => {
  ...
  return (
    <div>
      ...
      {/* Button add */}
      {!disabled && (
        <button type="button" className="mt-4 w-full justify-center px-6 py-2 bg-primary text-white rounded-full flex items-center" onClick={() => setIsModalOpen(true)}>
          <MdAdd className="mr-2" /> <span>Tambah Absensi</span>
        </button>
      )}
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-40">
          <div className="bg-white w-96 p-6 rounded-lg">
            <h2 className="text-lg font-bold mb-4">Tambah Absensi</h2>
            <div className="mb-4">
