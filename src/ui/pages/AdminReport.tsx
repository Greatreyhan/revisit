...
import { MdDelete, MdPrint, MdDangerous, MdGppGood, MdArchitecture, MdClose } from "react-icons/md";
          ...
          <div className="relative">
            ...
            <div className="flex mt-2 gap-3 px-8 pt-4">
              <button
                ...
                type="button"
                onClick={() => deleteFromDatabase("report/" + allReports[keyData]?.userId + "/" + allReports[keyData]?.reportId)}
              >
              ...
              <Link
                ...
                type="button"
                to={"/admin/report/" + allReports[keyData]?.userId + "/" + allReports[keyData]?.reportId}
              >
