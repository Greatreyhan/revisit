        ...
        >
          ...
          >
            ...
            <p>
              ...
              <strong>{dataArticle[confirmDeleteKey]?.customer}</strong>?
            </p>
          ...
          <tbody>
            {keyArticle.map((key, i) => (
              <tr key={key} className="text-gray-700 md:text-md text-sm">
                ...
                <td className="border-b p-4 dark:border-dark-5 flex flex-col h-full gap-1 items-center justify-center">
                  <span className="bg-sky-100 px-4 py-1 rounded-lg">
                    {formatDate(dataArticle[key]?.dateStart)}
                  </span>
                  <span className="bg-rose-100 px-4 py-1 rounded-lg">
                    {formatDate(dataArticle[key]?.dateEnd)}
                  </span>
                </td>
                <td className="border p-4 dark:border-dark-5 hidden md:table-cell">
                  {dataArticle[key]?.address}
                </td>
                <td className="border p-4 dark:border-dark-5">
                  {dataArticle[key]?.status === "pending" ? (
