...
const DealerHealth = () => {
  ...
  useEffect(() => {
    const fetchTrainingData = async () => {
      ...
      try {
        ...
        // Filter data health agar hanya menyertakan data yang berasal dari cabang yang sesuai.
  ...
  const handleExportReport = () => {
    ...
    const dataArr = Object.entries(data).map(([key, health]) => {
      // Jika terdapat field attachments (misalnya array objek), flatten dengan custom mapping
